...
define("USERNAME", "feltoltes"); // Your default username.
define("PASSWORD", "1404729779"); // Your default password.

$ft["settings"]["DIR"]               = "."; // Your default directory. Do NOT include a trailing slash!
$ft["settings"]["LANG"]              = "hu"; // Language. Do not change unless you have downloaded language file.
$ft["settings"]["MAXSIZE"]           = 20480000; // Maximum file upload size - in bytes.
